...
const SingleRefFaDocsPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      .service("refFaDocs")
      .get(urlParams.singleRefFaDocsId, {
        query: {
          $populate: [
            {
              path: "createdBy",
