...
const RefFacilitiesPage = (props) => {
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("refFacilities").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
